...
import (
	...
	service_mocks "task-manager/pkg/service/postgres/mocks"
	"testing"
)

func TestHandler_signUp(t *testing.T) {
	// Init Test Table
	type mockBehavior func(r *service_mocks.MockAuthorization, user entities.User)
	...
	tests := []struct {
	...
	}{
		{
			...
			mockBehavior: func(r *service_mocks.MockAuthorization, user entities.User) {
